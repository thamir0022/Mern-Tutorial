...
const  Footer = () => {
  return (
    <footer className="px-4 divide-y dark:bg-gray-100 dark:text-gray-800 mt-auto">
	...
	<div className="py-6 text-sm text-center dark:text-gray-600">© {new Date().getFullYear()} Amazon Co. All rights reserved.</div>
</footer>
  )
}
